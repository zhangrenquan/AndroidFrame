...
public class SPUtils {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "universal";

    /**
     * 保存数据的方法，我们需要拿到保存数据的具体类型，然后根据类型调用不同的保存方法
     */
    public static void putParam(@NonNull Context context, String key, Object object) {
    ...
    //保存对象
    public static boolean setObjectToShare(Context context, @Nullable Object object, String key) {
     ...
     */
    @Nullable
    public static Object getParam(@NonNull Context context, String key, Object defaultObject) {
        SharedPreferences sp = context.getSharedPreferences(FILE_NAME, Context.MODE_PRIVATE);
